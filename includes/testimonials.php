...
<section class="testimonials-section">
  <div class="container">
    ...
    <div class="testimonials-grid">
      ...
      <div class="testimonial-card">
        ...
        <div class="testimonial-author">
          ...
          <div class="author-info">
            <h4>Vijay Kumar</h4>
            <p>Online MBA Alumni &bull; Senior Financial Analyst</p>
          </div>
        </div>
      </div>
      ...
      <div class="testimonial-card">
        <div class="testimonial-quote">
          "The faculty support and live weekend interactive classes were top notch. The career service team assisted me in landing a software engineer position right after completing my MCA."
        </div>
        <div class="testimonial-author">
          <div class="author-avatar">K</div>
          <div class="author-info">
            <h4>K M Naidu</h4>
            <p>Online MCA Graduate &bull; Full Stack Developer</p>
          </div>
        </div>
      </div>
      ...
      <div class="testimonial-card">
        ...
        <div class="testimonial-author">
          ...
          <div class="author-info">
            <h4>Swati Sharma</h4>
            <p>Online BCA Alumni &bull; Data Associate</p>
          </div>
        </div>
      </div>
